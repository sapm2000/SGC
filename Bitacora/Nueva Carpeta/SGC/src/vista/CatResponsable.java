...
public class CatResponsable extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Listado de Responsables");
        ...
        btnNuevo.setText("Nuevo Responsable");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CatResponsable.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new CatResponsable().setVisible(true);
            }
        });
    }
