 ...
 * @author Maryo
 */
public class catalogoInactivoInteres extends javax.swing.JFrame {

    /**
     * Creates new form catalogoInactivoInteres
     */
    ...
    public catalogoInactivoInteres() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "<html>N° de <br> Interes</html>", "<html>Nombre de <br> Interes</html>", "Factor", "<html>N° de <br> Condominios</html>", "Estatus", "Seleccione"
            }
        ));
        ...
        jLabel3.setText("Listado de Intereses Inactivos");
        jPanel1.add(jLabel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 10, -1, -1));

        jLabel1.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        jLabel1.setText("Buscar:");
        jPanel1.add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 70, 70, 20));

        jTextField1.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        jTextField1.setToolTipText("Buscador");
        jTextField1.setBorder(null);
        jPanel1.add(jTextField1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 70, 190, 20));

        jSeparator3.setBackground(new java.awt.Color(0, 94, 159));
        jSeparator3.setForeground(new java.awt.Color(0, 94, 159));
        jPanel1.add(jSeparator3, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 90, 190, 10));
        ...
        btnActivar.setText("Activar Intereses");
        btnActivar.setToolTipText("Activar los interes seleccionados");
        ...
        jPanel1.add(btnActivar, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 60, -1, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogoInactivoInteres.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new catalogoInactivoInteres().setVisible(true);
            }
        });
    }
