 ...
 * @author rma
 */
public class cerrarMes extends javax.swing.JFrame {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(cerrarMes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
