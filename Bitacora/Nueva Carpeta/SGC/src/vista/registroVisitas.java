...
public class registroVisitas extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        if (tabla.getColumnModel().getColumnCount() > 0) {
            tabla.getColumnModel().getColumn(0).setHeaderValue("Cédula");
            tabla.getColumnModel().getColumn(1).setHeaderValue("Nombre");
            tabla.getColumnModel().getColumn(2).setHeaderValue("Apellido");
            tabla.getColumnModel().getColumn(3).setHeaderValue("Fecha Entrada");
            tabla.getColumnModel().getColumn(4).setHeaderValue("Hora Entrada");
            tabla.getColumnModel().getColumn(5).setHeaderValue("Unidad");
        }
