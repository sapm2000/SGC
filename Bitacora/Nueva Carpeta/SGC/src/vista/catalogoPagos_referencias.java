...
public class catalogoPagos_referencias extends javax.swing.JFrame {
    ...
    public catalogoPagos_referencias() {
        initComponents();
        jTable.getTableHeader().setDefaultRenderer(new catalogoUsuario.Headercolor());
        jScrollPane1.getVerticalScrollBar().setUI(new catalogoPagos_referencias.MyScrollBarUI());
    ...
    private void initComponents() {
        ...
        txtBusqueda.setToolTipText("Buscador");
        txtBusqueda.setBorder(null);
        jPanel1.add(txtBusqueda, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 80, 240, 20));

        jSeparator1.setBackground(new java.awt.Color(0, 94, 159));
        jSeparator1.setForeground(new java.awt.Color(0, 94, 159));
        jPanel1.add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(580, 100, 240, 10));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(catalogoPagos_referencias.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new catalogoPagos_referencias().setVisible(true);
            }
        });
    }
