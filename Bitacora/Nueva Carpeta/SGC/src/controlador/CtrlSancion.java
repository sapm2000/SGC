...
public class CtrlSancion implements ActionListener, MouseListener, KeyListener, WindowListener, ItemListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if (e.getSource() == catalogo.reportes) {
            ...
            try {
                ...
                String path = "src\\reportes\\sancion.jasper";

                String x = catalogo.txtBuscar.getText();

                Map parametros = new HashMap();
                parametros.put("sancion", x);
        ...
        if (e.getSource() == vista.btnGuardar) {
            if (validar()) {
                ...
                modsan.setAño(Integer.parseInt(vista.txtAnio.getSelectedItem().toString()));
    ...
    public void keyTyped(KeyEvent e) {
        ...
        if (e.getSource() == vista.txtAnio) {
            Validacion.limite(e, String.valueOf(Integer.parseInt(vista.txtAnio.getSelectedItem().toString())), 4);
